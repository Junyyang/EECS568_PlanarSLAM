...
int main(int argc, char **argv)
{
    ...
    Planar_SLAM::System SLAM(argv[1], argv[2], Planar_SLAM::System::RGBD, true);  // argv[1], argv[2] path_to_vocabulary path_to_settings
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        // imRGB.convertTo(imRGB, CV_16U);
        imD.convertTo(imD, CV_16U);  // added
